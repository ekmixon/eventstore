...
func (i *internalMap) Lock(ctx context.Context, key string, timeout int32) (string, error) {
	if i.svc.mapc == nil {
		return "", errors.New("EventStore client is not connected")
	}
...
// Unlock key.
func (i *internalMap) Unlock(ctx context.Context, key string, unlock string) error {
	if i.svc.mapc == nil {
		return errors.New("EventStore client is not connected")
	}
