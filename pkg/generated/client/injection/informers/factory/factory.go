...
import (
	...
	externalversions "github.com/triggermesh/eventstore/pkg/generated/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/eventstore/pkg/generated/client/informers/externalversions.SharedInformerFactory from context.")
	}
