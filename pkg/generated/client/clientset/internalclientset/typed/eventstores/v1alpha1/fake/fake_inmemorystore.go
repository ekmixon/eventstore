...
// FakeInMemoryStores implements InMemoryStoreInterface
type FakeInMemoryStores struct {
	Fake *FakeEventstoresV1alpha1
	ns   string
}

var inmemorystoresResource = schema.GroupVersionResource{Group: "eventstores.triggermesh.io", Version: "v1alpha1", Resource: "inmemorystores"}
...
func (c *FakeInMemoryStores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InMemoryStore, err error) {
	...
	return obj.(*v1alpha1.InMemoryStore), err
}
...
func (c *FakeInMemoryStores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InMemoryStoreList, err error) {
	...
	list := &v1alpha1.InMemoryStoreList{ListMeta: obj.(*v1alpha1.InMemoryStoreList).ListMeta}
	for _, item := range obj.(*v1alpha1.InMemoryStoreList).Items {
